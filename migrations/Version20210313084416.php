...
final class Version20210313084416 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE members (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(50) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, pid VARCHAR(50) NOT NULL, date DATETIME NOT NULL, avatar VARCHAR(255) DEFAULT NULL, signature VARCHAR(255) DEFAULT NULL, active TINYINT(1) DEFAULT \'1\' NOT NULL, is_verified TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_45A0D2FFF85E0677 (username), UNIQUE INDEX UNIQ_45A0D2FFE7927C74 (email), UNIQUE INDEX UNIQ_45A0D2FF5550C4ED (pid), UNIQUE INDEX UNIQ_45A0D2FF1677722F (avatar), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
